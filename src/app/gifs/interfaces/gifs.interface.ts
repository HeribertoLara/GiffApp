...
// To parse this data:
//
//   import { Convert, SearchGifsRespónse } from "./file";
//
//   const searchGifsRespónse = Convert.toSearchGifsRespónse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRespónse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRespónse(json: string): SearchGifsRespónse {
        return cast(JSON.parse(json), r("SearchGifsRespónse"));
    }

    public static searchGifsRespónseToJson(value: SearchGifsRespónse): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespónse")), null, 2);
    }
}
